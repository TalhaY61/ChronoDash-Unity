...
namespace ChronoDash.UI
{
    public class HealthUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                Debug.LogError("❌ HealthUI: HealthManager not found!");
            }
        }
        ...
        private void InitializeHearts(int maxHealth)
        {
            ...
            Debug.Log($"💚 HealthUI: Initialized {maxHealth} hearts");
        }
        ...
        private void UpdateHealthDisplay(int currentHealth, int maxHealth)
        {
            ...
            Debug.Log($"💚 HealthUI: Updated display - {currentHealth}/{maxHealth} hearts");
        }
    }
}
