...
namespace ChronoDash.Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (standingCollider == null || duckCollider == null)
            {
                Debug.LogError("Please assign both Standing Collider and Duck Collider in the Inspector!");
            }
        ...
        private void CheckGroundStatus()
        {
            ...
            {
                hasUsedDoubleJump = false;
                Debug.Log("Player landed - double jump reset");
            }
        }
        ...
        private void Jump(bool isDoubleJump)
        {
            ...
            Debug.Log($"Jump! Type: {(isDoubleJump ? "DOUBLE" : "NORMAL")}, Force: {currentJumpForce}, isGrounded: {isGrounded}");
