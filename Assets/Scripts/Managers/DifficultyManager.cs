    ...
    public class DifficultyManager : MonoBehaviour
    {
        ...
        public void AddScore(int points)
        {
            ...
            if (newTier != currentDifficultyTier)
            {
                ...
                UpdateDifficulty();
                OnDifficultyTierChanged?.Invoke(currentDifficultyTier);
                Debug.Log($"🎯 Difficulty increased to Tier {currentDifficultyTier}! Score: {currentScore}");
            }
        }
        ...
        public void SetScoreMultiplier(float multiplier)
        {
            ...
            OnScoreMultiplierChanged?.Invoke(scoreMultiplier);
            Debug.Log($"🔥 Score multiplier: x{multiplier:F1}");
        }
        ...
        private void UpdateDifficulty()
        {
            ...
            Debug.Log($"⚙️ Difficulty Updated - Tier {currentDifficultyTier}: Speed={CurrentObstacleSpeed:F0}, Gap={CurrentObstacleGap:F0}");
        }
