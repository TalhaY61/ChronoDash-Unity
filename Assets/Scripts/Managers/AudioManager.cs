    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        public float MusicVolume
        {
            ...
            set
            {
                ...
                ApplyMusicSettings();
                Debug.Log($"🔊 Music Volume: {(musicVolume * 100f):F0}%");
            }
        }
        ...
        private void LoadSettings()
        {
            ...
            ApplyMusicSettings();
            Debug.Log($"🎵 Audio settings loaded - Music: {musicEnabled}, VFX: {vfxEnabled}, Volume: {musicVolume}");
        }
